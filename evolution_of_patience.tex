...
Time preferences describe how an agent's perceived value of a delayed reward changes as a function of the delay. 
...
the fruit salad discounted at a rate of 
\begin{align}
    \Delta_{\exp}(t) &= (1-r)^{t} \\
    &= e^{-\tilde r t} 
...
%A preference reversal of this nature is shown in Figure \ref{fig:discountedValueHyperbolic}.
