...
\end{equation}
Remark that between equations (\ref{eqn:disc_from_thresh}) and (\ref{eqn:stable_discounting}), the delay variable changes from $t$ to $a$. 
...
reward at age $a+1$. To compare delayed rewards against a common benchmark, delayed rewards are all translated to discounted value at
